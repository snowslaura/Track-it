...
```Highlights: ContextAPI,styled-components, react-loader-spinner, dayjs, LocalStorage, useState, vercel```
...
`Destaques: ContextAPI,styled-components, react-loader-spinner, dayjs, LocalStorage, useState, vercel`
